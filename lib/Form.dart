...
List<String> referralSourceDropDown = [
  ...
  'Burns Unit',
  'Cardiology',
  'Community Psychiatry Other HHS',
  'Community Psychiatry Other MNHHS',
  'Community Psychiatry RBWH',
  'Dermatology',
  'Ear, Nose & Throat (ENT)',
  'Endocrinology',
  'EPICentre',
  ...
  'General Sugery Team 1',
  'General Sugery Team 4',
  'General Surgery Team 2',
  'General Surgery Team 3',
  'General Surgery Team 5 (ASU)',
  'Gynaecological Oncology',
  'Gynaecology',
  'Haematology',
  'Hepatology',
 "Hospital Executive (Ryan's Rule, Medical Aeroevacuation Procedure)",
  'Infectious Diseases',
  'Inpatient Psychiatry Other HHS',
  'Inpatient Psychiatry Other MNHHS',
      'Inpatient Psychiatry RBWH',
      'Intensive Care Unit (ICU)',
  'Matenity and Newborns',
  'Maxillo Facial Surgery',
  'Medical Unit Team 1A',
  'Medical Unit Team 1B',
  'Medical Unit Team 2A',
  'Medical Unit Team 2B',
  'Medical Unit Team 3A',
  'Medical Unit Team 3B',
  'Medical Unit Team 4A',
  'Medical Unit Team 4B',
 'Multidisciplinary Pain Centre (TCPRC)',
  ...
  'Orthopaedic Team 3',
  'Orthopaedic Team 5',
  'Other Referral Source NEC',
  'Palliative care',
  'Plastic Surgery',
  'Private Hospital (non-psych)',
  'Private Hospital (psych)',
  'Private Psychiatrist (community)',
  'Private Psychiatrist (inpatient)',
...
class _FormPageState extends State<FormPage> {
  ...
  showConfirmDialog(BuildContext context) {
    ...
    Widget confirmButton = TextButton(
      style: TextButton.styleFrom(
          backgroundColor: Color(0xff485e43),
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.all(Radius.circular(10)))),
      child: Text(
        "Confirm",
    ...
    Widget cancelButton = TextButton(
      child: Text(
        "Cancel",
        style: TextStyle(color: Color(0xff485e43)),
      ),
      onPressed: () {
        Navigator.pop(context);
      },
